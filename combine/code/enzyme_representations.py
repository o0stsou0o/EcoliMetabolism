...
def calcualte_esm1b_ts_vectors(enzyme_list):
    ...
    #print(model_dict_V2.keys())
    #print("model dict keys")
    #print(list(model.named_parameters()))  #now go through this and extract parameters from tuples
    b = (list(model.named_parameters()))
    params = [c[0] for c in b]
    #print(params)
    #print(model_dict_V2.named_parameters())
    #assert False
